...
let main argv =
    ...
    let beatmap = parseBeatmapFile @"C:\Program Files\osu!\Songs\1120543 Hanatan - Hajimete no Oto\Hanatan - Hajimete no Oto (Hishiro Chizuru) [Passion].osu"

    //printfn "timing points:"
    //timingpoints
    //|> List.iter printTimingPoint
